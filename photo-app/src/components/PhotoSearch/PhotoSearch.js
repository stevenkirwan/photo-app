...
class PhotoSearch extends Component {
    ...
    componentDidMount() {
        ...
        const URL = `https://api.flickr.com/services/rest/?method=flickr.photos.search&tags=farm&text=farm&api_key=4c4c949d05abc5434e054a68b10c1e6e&format=json&nojsoncallback=1`;
        ...
        return (
            <div>
                ...
                {this.state.error ? (
                     ...
                     */
                    <div id="myDiv" onScroll={this._handleScroll}>
                        <Card
